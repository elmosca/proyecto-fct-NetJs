...
export class InitialSchema1751961232508 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // Primero, intentar eliminar el tipo si ya existe para evitar errores
        ...
        // Primero, intentar eliminar el tipo si ya existe para evitar errores en users_status_enum
        await queryRunner.query(
