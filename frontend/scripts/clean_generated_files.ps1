...
Write-Host " Limpiando archivos generados por Flutter del tracking de Git..." -ForegroundColor Cyan
...
Write-Host " Ahora solo se committearán archivos de código fuente" -ForegroundColor Green